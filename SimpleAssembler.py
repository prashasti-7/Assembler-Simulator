    ...
    if(input_list[i][0][-1]==':'):
        ...
        if(label_inst in reg_code or label_inst in var_list or label_inst in op_code):
            ...
            if(len(input_list[i])>1):
                if(input_list[i][1]=='hlt'):
                    break

    elif (input_list[i][0]=='hlt' and i!=len_list-1):
            ...
            if(input_list[i][1] in op_code):
                ...
                # Type C:
                    ...
                    if(input_list[i][2] in reg_code and input_list[i][3] in reg_code):
                        final_print.append(op_code['div']+'00000' + reg_code[input_list[i][2]] + reg_code[input_list[i][3]])
                    else:
                        error_list.append("ERROR!Register format incorrect."+"-"+"Line "+str(i))         

                elif(input_list[i][1]=='not' and len_inst==4):
                    if(input_list[i][2] in reg_code and input_list[i][3] in reg_code):
                        not_final.append(op_code['not']+'00000' + reg_code[input_list[i][2]] + reg_code[input_list[i][3]])
                    else:
                        error_list.append("ERROR!Register format incorrect."+"-"+"Line "+str(i))

                elif(input_list[i][1]=='cmp' and len_inst==4):
                    if(input_list[i][2] in reg_code and input_list[i][3] in reg_code):
                        final_print.append(op_code['cmp']+'00000' + reg_code[input_list[i][2]] + reg_code[input_list[i][3]])
                    else:
                        error_list.append("ERROR!Register format incorrect."+"-"+"Line "+str(i))

                #Type D
                elif(input_list[i][1]=='ld' and len_inst==4):
                    if(input_list[i][2] in reg_code):
                        if(input_list[i][3] in var_list):
                            final_print.append(op_code['ld'] + reg_code[input_list[i][2]] + var_dict[input_list[i][3]])    
                            i+=1
                        else:
                            error_list.append("Error! Variable not declared at the beginning"+"-"+"Line "+str(i))
                            i+=1
