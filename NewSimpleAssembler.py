...
for line in file:
    ...
    for i in line.split():
        input_sim.append(i)
# ['1001000100000101','1001001000000001','1010001100011110','1000000011010011','1010101100011110','1010010000011011','1010010100011100',
# '1010011000011101','1010010000011000','1010010100011001','1010011000011010','1000000100010100','1000000101100101','1000000110101110','1010110000011010',
# '1010110100011001','1010111000011000','1010110000011101','1010110100011100','1010111000011011','1111000000011001','0110100000010111','1111100000000010','0101000000000000']
...
while i < len_sim:
    ...
    if(op_sim in A_sim):
        ...
        if(A_sim[op_sim] == 'add'):
            # reg_value[a1] = int(reg_value[a1])
            # reg_value[a2] = int(reg_value[a2])
    ...
    # res = str(dec_to_bi_8(pc_count)) + ' ' + str(reg_value['000']) + ' ' + str(reg_value['001']) + ' ' + str(reg_value['010']) + ' ' + str(reg_value['011']) + ' ' + str(reg_value['100']) + ' ' + str(reg_value['101']) + ' ' + str(reg_value['110']) + ' ' + str(reg_value['111'])
    final_sim.append(res)
    # pc_count += 1
    i+=1
    pc_list.append(pc_count)
